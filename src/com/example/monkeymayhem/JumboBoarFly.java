...
public class JumboBoarFly extends BoarFly {
	//bigger version of the pig we've come to love
		public JumboBoarFly(int centerX, int centerY, int width, int height,
				Monkey monkey) {
		...
		public JumboBoarFly(int width, int height, Monkey monkey){
