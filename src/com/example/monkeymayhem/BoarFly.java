...
public class BoarFly extends Enemy {
	public BoarFly(int width, int height, Monkey monkey) {
	...
	public BoarFly(int centerX, int centerY, int width, int height,Monkey monkey) {
